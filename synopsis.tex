...
\input{synopsis_contents/introduction}
\input{synopsis_contents/motivation}
\input{synopsis_contents/research_gap}
\input{synopsis_contents/proposed_work}
\input{synopsis_contents/results}
\input{synopsis_contents/thesis_oragnization}
