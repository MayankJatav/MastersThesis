...
\input{contents/fabric_classification/future_work}

% PART II: Internship Work
\include{contents/soar_soc/project_overview}
\input{contents/soar_soc/soc_overview}
\input{contents/soar_soc/siem_overview}
\input{contents/soar_soc/soar_components}
\input{contents/soar_soc/future_work}
\input{contents/soar_soc/internship_certificate}
